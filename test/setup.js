 ...
 */
var indexedDb = getParameterByName('imp') ? window.indexedDB : window.mock.indexedDB;
var KeyRange = getParameterByName('imp') ? window.IDBKeyRange : window.mock.IDBKeyRange;
